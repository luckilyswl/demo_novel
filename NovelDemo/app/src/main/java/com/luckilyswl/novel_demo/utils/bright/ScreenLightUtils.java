...
public class ScreenLightUtils {
    ...
    public static int getScreenMode(Context context) {
        ...
        int screenMode = 0;
        try {
            screenMode = Settings.System.getInt(resolver, Settings.System.SCREEN_BRIGHTNESS_MODE);
    ...
    public static void setScreenMode(Context context,int paramInt) {
        ContentResolver resolver = context.getContentResolver();
        try {
            Settings.System.putInt(resolver, Settings.System.SCREEN_BRIGHTNESS_MODE, paramInt);
        } catch (Exception localException) {
     ...
     * @param brightness
     */
    public static void changSystemBrightness(Context context,int brightness) {
        ContentResolver resolver = context.getContentResolver();
        try {
            if (Settings.System.SCREEN_BRIGHTNESS_MODE_MANUAL != (Settings.System.getInt(resolver, Settings.System.SCREEN_BRIGHTNESS_MODE))) {
                //设置为手动调节模式
